 ...
 function dwarfClient() {
   ...
   var dwarf = new Dwarf("Dwarf", "male", "Leif", 259,
     //sexual
  "I really really really like women, yes indeed... and my axe. Her name is Doris the Sharp",
     //interest
  "Well... my axe and stuff with axes is mostly my interests",
  ...
  "Sorry, don´t understand you question. Type it in dwarfish");
   ...
   var getAnswer = function() {
       ...
       if (question.indexOf("what are you") !== -1 || question.indexOf("type") !== -1) {
         logAnswer = "I am a " + dwarf.type + " you stupid human!";
       }
       //gender:
       ...
       //age:
         ...
         logAnswer = "I am only " + dwarf.age + ". Like a litle qute puppy";
       }
       //sexual:
